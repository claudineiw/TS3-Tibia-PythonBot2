                        ...
                        if (players_and_outstanding_payment[j]["balance"] > 0):
                            if (players_and_outstanding_payment[j]["balance"] > abs(
                                ...
                                players_and_outstanding_payment[j]["balance"] = players_and_outstanding_payment[j][
                                                                                    "balance"] + \
                                                                                players_and_outstanding_payment[i][
                                                                                    "balance"]
                                who_to_pay_and_how_much.append({'name': players_and_outstanding_payment[i]["name"],
                                                                'amount': abs(
                                                                    players_and_outstanding_payment[i]["balance"]),
                                                                'to_who': players_and_outstanding_payment[j]["name"], })
                                players_and_outstanding_payment[i]["balance"] = 0
                            else:
                                players_and_outstanding_payment[i]["balance"] = players_and_outstanding_payment[i][
                                                                                    "balance"] + \
                                                                                players_and_outstanding_payment[j][
                                                                                    "balance"]
                                players_and_outstanding_payment[j]["balance"] = round(
