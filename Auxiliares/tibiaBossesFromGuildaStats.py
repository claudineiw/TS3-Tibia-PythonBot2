        ...
        if None is not lista:
            ...
            for itens in lista:
                novaDescricao += "[tr][td]{}[/td][td]{}[/td][td]{}[/td][td]{}[/td][/tr]".format(itens[0], itens[1],
                                                                                                itens[2], itens[3])
            novaDescricao += "[/table]"
            descricao = self.tsconn.channelinfo(cid=pegarIdChannel(self.tsconn, self.settings["canalBoss"]))[0][
                "channel_description"]
            if descricao != novaDescricao:
                self.tsconn.channeledit(cid=pegarIdChannel(self.tsconn, self.settings["canalBoss"]),
