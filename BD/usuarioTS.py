        ...
        if(len(idMain)==0):
            ...
            if (len(idMaker) == 0):
                ...
                if(len(dadosMain)==0):
                    ...
                    updateMakers = "UPDATE usuariots SET idmakers=array_append(idmakers,{}) WHERE idcharactermain={};".format(idMaker[0][0], idMain[0][0])
        ...
        if (len(idMain) == 0):
            ...
            if (len(idMaker) == 0):
                ...
                if (len(dadosMain) == 0):
                    ...
                    updateMakers = "UPDATE usuariots SET idmakers=array_remove(idmakers,{}) WHERE idcharactermain={};".format(idMaker[0][0], idMain[0][0])
                    con.update(updateMakers)
                    return True
                else:
    ...
    def insert(self):
        ...
        if (len(resultSelect) == 0):
            ...
            if (char is None):
                ...
                addCharBd = charBd(char.name, char.level, 0, char.world, char.guild_name, char.vocation.name,"0", 0, 1, self.con)
                self.idChar = addCharBd.insert()
                self.name=char.name
                sqlInsertUsuarioTS = "INSERT INTO usuariots (nomets,idcharactermain,uidusuario) VALUES('{}',{},'{}')".format(self.nomeTS,self.id,self.uIdUsuario)
